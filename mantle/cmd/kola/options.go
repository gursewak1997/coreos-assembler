...
var (
	...
	kolaPlatforms     = []string{"aws", "azure", "do", "esx", "gcp", "kubevirt", "openstack", "packet", "qemu", "qemu-unpriv", "qemu-iso"}
...
func init() {
	...
	sv(&kola.KubevirtOptions.Container, "container", "", "Path to a kubevirt based container")
