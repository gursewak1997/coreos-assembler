...
func NewFlight(opts *kubevirt.Options) (platform.Flight, error) {
	fmt.Printf("Running new flight for KubeVirt ")
	api, err := kubevirt.New(opts)
	if err != nil {
		return nil, err
	}
	fmt.Printf("After flight launch ")
